...
3. [Performing Titrations](#performing-titations)
4. [Performing Parameterizations](#performing-parameterizations)
5. [Running CpHMD simulations on HPC resources](#running-cphmd-simulations-on-hpc-resources)
6. [Synopsis `phbuilder gentopol`](#synopsis-phbuilder-gentopol)
7. [Synopsis `phbuilder neutralize`](#synopsis-phbuilder-neutralize)
8. [Synopsis `phbuilder genparams`](#synopsis-phbuilder-genparams)
...
| Flag<span style="color:white">_____</span> | Description    |
|--------------|----------------|
| `-f`         | [\<.pdb/.gro>] (required) <br /> Specify input structure file. | 
